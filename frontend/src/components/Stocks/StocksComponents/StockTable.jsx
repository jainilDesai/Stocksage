        ...
        <Box className="box">
          ...
          >
            ...
            {type === "trending" ? (
              ...
              >
                <Button
                  onClick={() => getTrendingStocks()}
                  color={buttonSelected !== "all" ? "blackAlpha.600" : "#000"}
                  bgColor={buttonSelected === "all" ? "gray.100" : null}
                >
                  All
                </Button>
                <Button
                  onClick={() => getTrendingStocks("winners")}
                  color={
                    buttonSelected !== "winners" ? "blackAlpha.600" : "#000"
                  }
                  bgColor={buttonSelected === "winners" ? "gray.100" : null}
                >
                  Winners
                </Button>
                <Button
                  onClick={() => getTrendingStocks("lossers")}
                  color={
                    buttonSelected !== "lossers" ? "blackAlpha.600" : "#000"
                  }
                  bgColor={buttonSelected === "lossers" ? "gray.100" : null}
                >
                  Lossers
                </Button>
              </ButtonGroup>
              ...
              <Tbody>
                {data.map((stock, index) => {
                  return (
                    <Tr
                      backgroundColor={
                        (stock.Type === "buy" && "green.100") ||
                        (stock.Type === "sell" && "red.100")
                      }
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <Box
                            ...
                            gap="20px"
                          >
                            <Text className="capitalize" fontWeight="600">
                              {stock.Type}
                            </Text>
                          </Box>
                          <Box
                          ...
                          >
                            ...
                            <Box>
                              <Text w="100px" fontWeight="600">
                                {stock.CompanyName.length > 11
                                  ? stock.CompanyName.slice(0, 11) + "..."
                                  : stock.CompanyName}
                              </Text>
                      ...
                      <Td>
                        <Button
                          ...
                          style={{ cursor: "pointer" }}
                          onClick={
                            hasStock(stock.Symbol)
                              ? () => handleDeleteFromWatchList(stock)
